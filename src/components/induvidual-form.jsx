        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select 
              ...
              onChange={(e) => setFormData({...formData, schoolTypeId: e.target.value})} 
              className="w-full px-3 py-2 rounded border border-gray-200 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center space-x-4">
              <input type="number" value={formData.previousFeeValidityYear.from} onChange={(e) => setFormData({...formData, previousFeeValidityYear: {...formData.previousFeeValidityYear, from: e.target.value}})} className="w-32 px-3 py-2 rounded border border-gray-200 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"/>
              <span>-</span>
              <input type="number" value={formData.previousFeeValidityYear.to} onChange={(e) => setFormData({...formData, previousFeeValidityYear: {...formData.previousFeeValidityYear, to: e.target.value}})} className="w-32 px-3 py-2 rounded border border-gray-200 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"/>
            </div>
          </div>
        </div>
      </div>
